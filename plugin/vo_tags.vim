...
if !hasmapto('<Plug>VO_FollowLink')
	...
	map <buffer> <C-K> <Plug>VO_FollowLink
endif
...
if !hasmapto('<Plug>VO_JumpBack')
	...
	map <buffer> <C-N> <Plug>VO_JumpBack
endif
...
if !hasmapto('<Plug>VO_CreateLink')
	map <unique> <buffer> <localleader>l <Plug>VO_CreateLink
endif
...
if !hasmapto('<Plug>VO_CreateLinkI')
	imap <unique> <buffer> <localleader>l <Plug>VO_CreateLinkI
endif
